...
function Contact() {
  return (
    <main>
      ...
      <h1>CONTACT US</h1>
      <p className='cub-paragraph' >HOME<span>/CONTACT US</span></p>
      </section>
      <section className='contain'>
      <h3 className='get-intouch'>Get In Touch</h3>
      <p className='details'>Connect with our  event coordinators and organizing committees,we are here to help you with all your campus event needs.</p>
      </section>
      <section className='bar'>
          <div className='box'>
            <button className='mail'><i class="fa-solid fa-envelope"></i></button>
            <h4>Email Us</h4>
              <p className='ash'>campusConnect34@gmail.com Response within 24 hours</p>
          </div>
          <div className='box'>
            <button className='mail'><i class="fa-solid fa-phone"></i></button>
            <h4>Call Us</h4>
            <p className='ash'>+234-8071370987 Mon-Fri 9AM-5PM</p>
            </div>
          <div className='box'>
            <button  className='mail'><i class="fa-solid fa-location-dot"></i></button>
            <h4>Visit Us</h4>
      ...
      <section className='contact-location'>
         ...
         <div>
           ...
           <p className='location'>Campus Connect Event Management Office
              Ground Floor, Student Activity Center
              Aptech Benin
              99B Austin building,First East Circular road
              Benin-City Edo State 12345</p>
            <h4 className='off'>Office Hours</h4>
            <p className='location'>Monday-Friday: 9:00AM - 5:00 PM
              Saturday: 10:00AM - 2:00PM
              Sunday: Closed</p>
              <h4 className='off'>Emergency Support</h4>
                <p className='location'>24/7 Helpline: +234 (0) 8071370987
              Emergency Email: divinefavouroni@gmail.com</p>
              </div>
              <div><MapEmbed/></div>
              </div>
